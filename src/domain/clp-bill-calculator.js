...
export function listCalendarMonthsInPeriod(startDate, endDate) {
...
export function splitKwhAcrossPeriod(startDate, endDate, totalKwh, monthlyKwh = {}) {
...
export function inferMonthlyKwhFromBillTargets({
    startDate,
    endDate,
    totalKwh,
    targetBasic,
...
export function formatMoneyHkd(amount) {
...
export function formatClpBillLinesHtml(bill, options = {}) {
    if (!bill) return '';
...
export class ClpBillCalculator {
    static sumBillLines({
        basicCharge,
        fuelCharge,
        broughtForward = 0,
